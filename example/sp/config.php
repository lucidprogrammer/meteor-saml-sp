...
$config = [
     ...
     */
    'technicalcontact_name' => getenv('technicalcontact_name')?getenv('technicalcontact_name'):'Administrator',
    'technicalcontact_email' => getenv('technicalcontact_email')?getenv('technicalcontact_email'):'na@example.org',
     ...
     */
    'secretsalt' => getenv('secretsalt')?getenv('secretsalt'):'mysecretsalt',
     ...
     */
    'auth.adminpassword' => getenv('adminpassword')?getenv('adminpassword'):'password',
